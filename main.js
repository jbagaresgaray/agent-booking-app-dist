...
var map = {
	...
	"./products-detail/products-detail.module": [
	...
	"./search-connect/search-connect.module": [
		"./src/app/search-connect/search-connect.module.ts",
		"search-connect-search-connect-module"
	]
};
function webpackAsyncContext(req) {
...
var routes = [
    ...
    { path: 'search-connect', loadChildren: './search-connect/search-connect.module#SearchConnectPageModule' },
...
var AppComponent = /** @class */ (function () {
    function AppComponent(router, platform, menuCtrl, splashScreen, statusBar) {
        this.router = router;
...
module.exports = __webpack_require__(/*! /Applications/XAMPP/xamppfiles/htdocs/agent-booking-app/src/main.ts */"./src/main.ts");
